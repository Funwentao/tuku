...
<body>
	...
	<form:form id="inputForm" modelAttribute="gallery" action="${ctx}/basic/gallery/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:hidden id="imgs" path="imgs" htmlEscape="false" maxlength="255" class="input-xlarge"/>
				<sys:ckfinder input="imgs" type="images" uploadPath="/photo" selectMultiple="true" maxWidth="100" maxHeight="100"/>
			</div>
		</div>
